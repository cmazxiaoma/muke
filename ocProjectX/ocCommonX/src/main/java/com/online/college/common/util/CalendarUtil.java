...
public class CalendarUtil {
    ...
    public static void main(String[] args) {
        /*
         * String startTime = "2009-12-14"; String endTime = "2010-1-14"; List<String>
         * list = getBetweenDateStr(startTime,endTime); for(String s : list){
         * System.out.println(s); }
         */
        /*
         * String nextday = getNextDay("yyyy-MM-dd"); String xday =
         * getPreXDay(6,"yyyy-MM-dd"); System.out.println(nextday);
         * System.out.println(xday); System.out.println(getFirstDay("yyyy-MM-dd"));
         * System.out.println(getLastDay("yyyy-MM-dd"));
         */

        /*
         * try { Date startTime = DateUtil.COMMON.getTextDate("2015-06-03 00:00:00");
         ...
         *
         * List<String> month = getPreNMonths("2015-06",11); for(String s : month){
         * System.out.println(s); }
         *
         ...
         * for(String s : days){ System.out.println(s); }
         *
        ...
        Map<String, String> oneMap = CalendarUtil.getMonthFirstEndDayTime(Integer.toString(year),
                Integer.toString(month - 11));// 当前月第一天的00:00:00
        Map<String, String> oneEndMap = CalendarUtil.getMonthFirstEndDayTime(Integer.toString(year),
                Integer.toString(month));// 当前月最后一天的23:59:59
